					...
					<div class="widget-summary">
						...
						<div class="widget-summary-col">
							<div class="summary">
								...
								<div class="info">
									<a href="add" class="mb-xs mt-xs mr-xs btn btn-sm btn-warning text-uppercase"><i class="fa fa-plus"></i> Form Beli Grey</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="toggle-content panel-body">
						...
						<form id="filter_submit" name="filter_submit" method="post" action="<?php echo c_XELF;?>" class="form-inline">
							<div class="form-group">
								...
								<input name="no_sp" id="no_sp" data-plugin-masked-input data-input-mask="SBG-9999" placeholder="SBG-____" class="form-control">
							</div>
							<div class="form-group">
		...
		<div class="col-md-12">
			<section class="panel panel-primary">
				<header class="panel-heading">
					...
					<h2 class="panel-title">Pemesanan Grey</h2>
				...
				<div class="panel-body">
					<table class="table table-bordered table-striped mb-none" id="datatable-details">
						...
						$sql -> db_Select("DCMS_sbg G LEFT JOIN customer C ON G.C_ID=C.CID", 
								"G.SBG_ID, G.tgl_sp, G.no_sp, C.c_name, C.c_corp, C.c_alamat", 
								"WHERE ".$sql_filter." ");
						...
						while($row = $sql-> db_Fetch()){
							...
							echo "
							<tr>
								<td><a href='./printview?landing=".$row['SBG_ID']."'>SBG-".$row['no_sp']."</a></td>
								<td>".date("d M Y", strtotime($row['tgl_sp']))."</td>
								<td><span class='ellipsis'>".$customer."</span></td>
								<td class='hidden'>".$row['c_alamat']."</td>
								<td class='text-center hidden'>
									<a href=\"./printview?landing=".$row['SBG_ID']."\" class=\"mb-xs mt-xs mr-xs btn btn-xs btn-primary text-uppercase\"><i class=\"fa fa-file\"></i> Invoice</a> 
									<a href=\"./print?landing=".$row['SBG_ID']."\" target=\"_blank\" class=\"mb-xs mt-xs mr-xs btn btn-xs btn-info text-uppercase\"><i class=\"fa fa-print\"></i> Print</a> 
									<a href=\"./printview?landing=".$row['SBG_ID']."\"><i class=\"fa fa-power-off\"></i></a>
								</td>
							</tr>";
						}
						?>
