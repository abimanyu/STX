...
$NAV_STATUS = NAV_STATUS("sbg", $sql_filter, $STATUS_SP);
...
$sql -> db_Select("DCMS_sbg G LEFT JOIN customer C ON G.C_ID=C.CID", 
		"G.SBG_ID, G.tgl_sp, G.no_sp, G.status, G.status_date, C.c_name, C.c_corp", 
		"WHERE ".$sql_filter." ");
$total_items =  $sql->db_Rows();
?>
<section role="main" class="content-body">
<header class="page-header">
	<h2><i class="fa fa-flag-o"></i> Pemesanan Beli Grey  <a href="add" class="mb-xs mt-xs mr-xs btn btn-primary btn-xs"><i class="fa fa-plus"></i> SBG Baru</a></h2>
...
<div class="input-group input-search"><input type="text" class="form-control" name="no_sp" id="no_sp" data-plugin-masked-input data-input-mask="SBG-9999" placeholder="SBG-____">
	...
	<div class="panel-body">
		<div class="widget-summary">
			<div class="widget-summary-col widget-summary-col-icon">
				<div class="summary-icon bg-primary"><i class="fa fa-flag-o"></i></div>
			</div>
			<div class="widget-summary-col">
				<div class="summary">
					<h4 class="title">Pembelian Grey</h4>
...
<section class="panel panel-featured-left panel-featured-tertiary">
	<div class="panel-body">
		<div class="widget-summary">
			<div class="widget-summary-col widget-summary-col-icon"><div class="summary-icon bg-tertiary"><i class="fa fa-share-square-o"></i></div></div>
			<div class="widget-summary-col">
				<div class="summary">
					<h4 class="title">Pending Stok Grey</h4>
					<div class="info"><strong class="amount">4 SP</strong><span class="text-info">(48 roll)</span></div>								
					<div class="info"><a href="add" class="mb-xs mt-xs mr-xs btn btn-sm btn-warning text-uppercase"><i class="fa fa-plus"></i> Form Beli Grey</a></div>
				</div>
			</div>
		</div>
	</div>
...
<section class="panel panel-featured panel-featured-primary">
	...
	<h2 class="panel-title">Pemesanan Beli Grey</h2><em class="panel-subtitle"><?php echo $DISPLAY;?></em>
	</header>
	<div class="panel-body">
		<table class="table table-bordered table-striped mb-none" id="datatable-default">
			...
			while($row = $sql-> db_Fetch()){
				...
				echo "
				<tr>
					<td><strong><a href='./invoice?landing=".$row['SBG_ID']."'>SBG-".$row['no_sp']."</a></strong></td>
					<td>".date("d M Y", strtotime($row['tgl_sp']))."</td>
					<td class='text-center'><div id=\"confirm-div\" data-id=\"".$row['SBG_ID']."\">".$action[ $row['status'] ][0]."
					...
					<td class='text-center'>
						<a href=\"./print?landing=".$row['SBG_ID']."\" target=\"_blank\" class=\"btn btn-xs btn-default\"><i class=\"fa fa-print\"></i> Print</a>
						<a href=\"./invoice?landing=".$row['SBG_ID']."\" class=\"btn btn-xs btn-default\"><i class=\"fa fa-file\"></i> Invoice</a>
					</td>
				</tr>";
			}
			?>
