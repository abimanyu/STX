...
<section role="main" class="content-body">
	<header class="page-header">
		<h2>Surat Pembelian Barang Jadi</h2>
		...
		<div class="right-wrapper pull-right">
			<ol class="breadcrumbs">
				...
				<li><span><a href="./front">Beli Jadi</a></span></li>
	...
	<section class="panel">
		<div class="panel-body">
				...
				<header class="clearfix">
					<div class="row">
						<div class="col-sm-6 mt-md">
							<h2 class="h2 mt-none mb-sm text-dark text-bold">SURAT PESANAN BELI JADI</h2>
					...
					<div class="col-md-6">
						<div class="bill-info">
							<div class="bill-to">
								...
								<address class="text-dark text-semibold">
			...
			<div class="text-right mr-lg">
				<a href="./front" class="btn btn-default"><i class="fa fa-arrow-left"></i> Kembali ke Pembelian Barang Jadi</a>
				<a href="./print?c=<?php echo $result['SBJ_ID'];?>" target="_blank" class="btn btn-primary ml-sm"><i class="fa fa-print"></i> Print</a>
			</div>
		</div>
	</section>
