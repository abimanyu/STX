	...
	<header class="page-header">
		...
		<div class="right-wrapper pull-right">
			<ol class="breadcrumbs">
				...
				<li><span>Permintaan</span></li>
				<li><span>Pencelupan</span></li>
			</ol>
			...
			<section class="panel panel-featured-left panel-featured-tertiary">
				<div class="panel-body">
					<div class="widget-summary">
						...
						<div class="widget-summary-col">
							<div class="summary">
								<h4 class="title">Pending Permintaan</h4>
								<div class="info">
									<strong class="amount">4 SP</strong>
									<span class="text-info">(48 roll)</span>
								</div>								
								<div class="info">
									<a href="#add" class="mb-xs mt-xs mr-xs btn btn-sm btn-info text-uppercase"><i class="fa fa-plus"></i> Form Permintaan Pencelupan</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="toggle-content panel-body">
						...
						<form id="filter_submit" name="filter_submit" method="post" action="<?php echo c_XELF;?>" class="form-inline">
							<div class="form-group">
								...
								<input name="no_sp" id="no_sp" data-plugin-masked-input data-input-mask="SPP-9999" placeholder="SPP-____" class="form-control">
							</div>
							<div class="form-group">
...
if(!empty($_POST['no_sp'])) {
  unset($sql_filter);
  $DISPLAY = "";
  $NO_SP = str_replace("SPP-", "", $_POST['no_sp']);
		...
		<div class="col-md-12">
			<section class="panel panel-primary">
				<header class="panel-heading">
					...
					<h2 class="panel-title">Permintaan Pencelupan</h2>
